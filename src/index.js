module.exports = {
    /**
     * activate(state):
     * This required method is called when your package is
     * activated. It is passed the state data from the last time the window was
     * serialized if your module implements the serialize() method. Use this to
     ...
     * your module’s activate method so you can restore your view to where the
     * user left off.
     */
    serialize: () => {},
    /**
     ...
     * way, release them here. If you’re just subscribing to things on window,
